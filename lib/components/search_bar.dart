...
import 'package:flutter_examen1/pages/departement_page.dart';
...
class SearchBarApp extends StatefulWidget {
  ...
  @override
  State<SearchBarApp> createState() => _SearchBarAppState(config: config);
}
...
class _SearchBarAppState extends State<SearchBarApp> {
  ...
  _SearchBarAppState({required this.config});
  ...
  void redirectDepartement(String value) {
    Navigator.push(
      context,
      MaterialPageRoute(
